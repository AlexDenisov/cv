...
\section{Projects}
  ...
  \cvline
    {Mutang (WIP)}
    {\url{https://github.com/AlexDenisov/mutation-testing-poc}\newline{}
    \textbf{LLVM-based mutation testing system.}\newline{}
    So far I implemented just a proof of concept.\newline{}
...
\section{Education}
  ...
  \cventry
    ...
    {\newline Learned basics about how our brain works}
    {}{\newline\url{https://www.coursera.org/learn/synapses/}}{}
  \cventry
    {Sep 2015 - Nov 2015}
    {Automata}
...
\section{Public Activity}
  ...
  \subsection{On the Internet}
    \cvline{Blog}{\url{http://lowlevelbits.org}}
